...
Feb_household_pwr$Global_active_powerKW <- Feb_household_pwr$Global_active_power/1000
...
plot(Feb_household_pwr$Datetime, Feb_household_pwr$Global_active_powerKW , type="l", ylab = "Global Active Power", xlab = "")
plot(Feb_household_pwr$Datetime, Feb_household_pwr$Voltage, type="l", ylab = "Voltage", xlab = "datetime")
...
legend("topright",legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),col  = c("black", "red", "blue"), lty=1 ,cex=0.65)
plot(Feb_household_pwr$Datetime, Feb_household_pwr$Global_reactive_power, type="l", ylab = "Global_reactive_power", xlab = "datetime")
